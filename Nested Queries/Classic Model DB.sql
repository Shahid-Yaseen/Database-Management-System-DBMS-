...
/*Q1*/
select employees.extension,employees.firstName, customers.customerName
from employees
inner join customers;
/*Q2*/
select c.customerName , c.addressLine1, p.amount
from customers c
inner join payments p
where p.amount>30000;

/*Q3*/
select p.productVendor, p.productName, o.quantityOrdered
from products p
inner join orderdetails o
where o.quantityOrdered<20;
...
from customers c
inner join payments p
where p.amount between 60000 and 70000; 
